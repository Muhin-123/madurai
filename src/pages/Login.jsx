        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {mode === 'register' && (
                ...
                >
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-navy-700/50 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-civic-green dark:focus:ring-civic-green transition-all"
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {[
                        ...
                        <button
                          ...
                          className={`p-3 rounded-xl text-xs text-center border transition-all font-semibold ${form.role === r.value
                            ? 'border-civic-green dark:border-civic-green bg-green-50 dark:bg-green-500/20 text-civic-green dark:text-civic-green'
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2.5 pr-11 rounded-xl bg-gray-50 dark:bg-navy-700/50 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-civic-green dark:focus:ring-civic-green transition-all"
                  placeholder={
                    mode === 'register'
            ...
            <motion.button
              ...
              className="w-full py-3 mt-2 rounded-xl font-bold text-[#0F2E1C] bg-gradient-to-r from-green-400 to-lime-400 hover:from-green-500 hover:to-lime-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg hover:shadow-xl shadow-green-900/50 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
